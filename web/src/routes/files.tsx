...
export function FilesRoute() {
  ...
  return <div className="mx-auto flex min-h-0 w-full flex-1 flex-col"><AppHeader bridge={home.bridge} error={home.error} wordmark={false} onBack={back}><span className="truncate font-semibold">{title}</span></AppHeader>
