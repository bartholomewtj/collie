...
// claude, which lifts every block kind; grok and omp, which are Tier 1 and lift none — they
// contribute chrome stripping and the composer gate only. `hasBlockGrammar` replaces the old grammar/agents predicate:
