...
(PDF, images, audio, video, and a few text types). HTML, SVG, XML and JS stay download-only — an
inline page from the work root would run as Collie. Nothing is written, renamed, deleted, uploaded,
or sent to a pane.
